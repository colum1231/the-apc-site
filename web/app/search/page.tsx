...
export default async function SearchPage({
  // IMPORTANT: this is a plain object in your setup — do NOT Promise/await it
  searchParams,
}: {
  ...
  // ask API (same-origin; avoids cross-project hops)
  ...
  // Keep your current initial counts so your existing CSS keeps its look
  const LEFT_COUNT = 5;
  const RIGHT_COUNT = 3;

  return (
    <main className="results">
      {/* faint landing bg like before */}
...
/** Right side dropdown (unchanged styles/structure). */
