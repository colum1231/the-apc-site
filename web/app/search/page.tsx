...
export default async function SearchPage({
  // IMPORTANT: treat searchParams as a plain object (do NOT Promise/await it)
  searchParams,
}: {
  ...
  // Ask API (same-origin to avoid cross-project hops)
  ...
  // Keep your existing initial counts so styling stays the same
  const LEFT_COUNT = 5;
  const RIGHT_COUNT = 3;

  return (
    <main className="results">
      {/* Reuse faint landing background */}
      ...
      <div className="results-shell">
        ...
        <section className="results-left">
          ...
          <div className="members-wrap">
            {/* Title bar with “corner” ticks style */}
